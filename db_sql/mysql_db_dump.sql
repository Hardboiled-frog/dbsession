CREATE DATABASE  IF NOT EXISTS `ippc` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci */;
USE `ippc`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: ippc
-- ------------------------------------------------------
...
CREATE TABLE `sesje` (
  `id` varchar(32) COLLATE utf8_polish_ci NOT NULL,
...
-- Dump completed on 2014-06-29 18:55:07
